...
<div class="full-width-split group">
    <div class="full-width-split__one">
        <div class="full-width-split__inner">
            ...
            */
             ...
             while($homePageEvents->have_posts()) {
                // This will get the data ready for each post, each time the loop repeats itself
                $homePageEvents->the_post(); ?>
            <div class="event-summary">
                <a class="event-summary__date t-center" href="#">
                    <!-- I installed a plugin to help me with the creation of custom fields. This plugin gives me a new function -->
        ...
        <!-- If there is a excerpt added, it will be displayed, otherwise only the first 2 sentences of the description will be displayed -->
